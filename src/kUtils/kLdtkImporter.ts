...
export class Convert {
  public static toLdtkJSON(json: string): LdtkJSON {
    return cast(JSON.parse(json), r("LdtkJSON"));
  }

  public static ldtkJSONToJson(value: LdtkJSON): string {
...
const typeMap: any = {
  ...
  LdtkTableOfContentEntry: o(
    [
      { json: "identifier", js: "identifier", typ: "" },
      {
        json: "instances",
        js: "instances",
        typ: a(r("ReferenceToAnEntityInstance")),
      },
    ],
    false
  ),
  ...
  When: ["AfterLoad", "AfterSave", "BeforeSave", "Manual"],
  AllowedRefs: ["Any", "OnlySame", "OnlySpecificEntity", "OnlyTags"],
  EditorDisplayMode: [
    "ArrayCountNoLabel",
    "ArrayCountWithLabel",
    "EntityTile",
  ...
  BgPos: ["Contain", "Cover", "CoverDirty", "Repeat", "Unscaled"],
